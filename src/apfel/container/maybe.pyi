...
class Maybe[T](Monad[T]):
    ...
    @classmethod
    def make_just(cls, value: T, /) -> Self: ...
    @classmethod
    def make_nothing(cls) -> Self: ...
    @classmethod
    def make_some(cls, value: T | None, /) -> Self: ...
    @classmethod
    def duplicate(cls, value: Maybe[T], /) -> Maybe[T]: ...
    ...
    def apply[U](self, func: Maybe[Callable[[T], U]], /) -> Maybe[U]: ...  # type: ignore
    def bind[U](self, func: Callable[[T], Maybe[U]], /) -> Maybe[U]: ...  # type: ignore
    ...
    def is_just_and(self, pred: Callable[[T], bool], /) -> bool: ...
    ...
    @classmethod
    def pure(cls, value, /) -> Maybe: ...  # type: ignore
    def replace(self, value: T, /) -> Maybe[T]: ...
    def __repr__(self) -> str: ...
    def __str__(self) -> str: ...
    def take(self) -> Maybe[T]: ...
    def take_if[U](self, pred: Callable[[T], bool], /) -> Maybe[T]: ...
    def tap(self, func: Callable[[T], Any], /) -> Maybe[T]: ...
    def unwrap(self) -> T: ...
    ...
    @overload
    def zip[T1, T2](
        self, *others: *tuple[Maybe[T1], Maybe[T2]]
    ) -> Maybe[tuple[T, T1, T2]]: ...
    @overload
    def zip[T1, T2, T3](
        self, *others: *tuple[Maybe[T1], Maybe[T2], Maybe[T3]]
    ) -> Maybe[tuple[T, T1, T2, T3]]: ...
    @overload
    def zip[T1, T2, T3, T4](
        self, *others: *tuple[Maybe[T1], Maybe[T2], Maybe[T3], Maybe[T4]]
    ) -> Maybe[tuple[T, T1, T2, T3, T4]]: ...
